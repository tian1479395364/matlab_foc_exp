###########################################################################
## Makefile generated for component 'FOC'. 
## 
## Makefile     : FOC.mk
## Generated on : Mon Apr 13 17:38:37 2026
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\FOC.exe
...
COMPILER_COMMAND_FILE     = FOC_comp.rsp
CMD_FILE                  = FOC.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
NODEBUG                   = 1
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\FOC.exe
...
DEFINES_STANDARD = -DMODEL=FOC -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)\FOC_ert_rtw\FOC.c $(START_DIR)\jscl_clarke.c $(START_DIR)\jscl_park.c

MAIN_SRC = $(START_DIR)\FOC_ert_rtw\ert_main.c
...
OBJS = FOC.obj jscl_clarke.obj jscl_park.obj
...
{$(START_DIR)\FOC_ert_rtw}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\FOC_ert_rtw}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\FOC_ert_rtw}.cc.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\FOC_ert_rtw}.cxx.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
FOC.obj : "$(START_DIR)\FOC_ert_rtw\FOC.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\FOC_ert_rtw\FOC.c"


ert_main.obj : "$(START_DIR)\FOC_ert_rtw\ert_main.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\FOC_ert_rtw\ert_main.c"
