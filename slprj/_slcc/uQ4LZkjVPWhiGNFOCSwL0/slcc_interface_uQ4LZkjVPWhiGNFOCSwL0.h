...
DLL_EXPORT_CC extern void CurrentLoopDQ_uQ4LZkjVPWhiGNFOCSwL0(real_T IRefD, real_T ISensD, real_T IRefQ, real_T ISensQ, real_T d_kp_param, real_T d_ki_param, real_T q_kp_param, real_T q_ki_param, real_T *Vd, real_T *Vq);
