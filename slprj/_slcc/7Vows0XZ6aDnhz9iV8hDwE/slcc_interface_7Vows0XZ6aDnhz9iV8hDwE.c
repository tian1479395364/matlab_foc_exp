/* Include files */
#include "rtwtypes.h"
#include "slcc_interface_7Vows0XZ6aDnhz9iV8hDwE.h"
...
const char_T *get_dll_checksum_7Vows0XZ6aDnhz9iV8hDwE(void)
{
    return "a3h3uUedd4bfzQpoRKD0WC";
}

void ClarkeTransform_7Vows0XZ6aDnhz9iV8hDwE(real_T ia, real_T ib, real_T ic, real_T *i_alpha, real_T *i_beta)
{
