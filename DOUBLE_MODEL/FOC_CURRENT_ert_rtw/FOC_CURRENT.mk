...
## Generated on : Tue Apr 14 17:48:40 2026
...
COMPILER_COMMAND_FILE     = FOC_CURRENT_comp.rsp
CMD_FILE                  = FOC_CURRENT.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
NODEBUG                   = 1
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\FOC_CURRENT.exe
...
DEFINES_STANDARD = -DMODEL=FOC_CURRENT -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)\FOC_CURRENT_ert_rtw\FOC_CURRENT.c E:\Exp_G431\NUM1_CURRENTLOOP\jscl_clarke.c E:\Exp_G431\NUM1_CURRENTLOOP\jscl_park.c
...
{$(START_DIR)\FOC_CURRENT_ert_rtw}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\FOC_CURRENT_ert_rtw}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\FOC_CURRENT_ert_rtw}.cc.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\FOC_CURRENT_ert_rtw}.cxx.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
FOC_CURRENT.obj : "$(START_DIR)\FOC_CURRENT_ert_rtw\FOC_CURRENT.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\FOC_CURRENT_ert_rtw\FOC_CURRENT.c"


ert_main.obj : "$(START_DIR)\FOC_CURRENT_ert_rtw\ert_main.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\FOC_CURRENT_ert_rtw\ert_main.c"
